...
FileEncryptionInfo DataKeyManager::getFile(const EncryptionPath & ep)
{
...
FileEncryptionInfo DataKeyManager::newFile(const EncryptionPath & ep)
{
...
void DataKeyManager::deleteFile(const EncryptionPath & ep, bool throw_on_error)
{
...
void DataKeyManager::linkFile(const EncryptionPath & src_ep, const EncryptionPath & dst_ep)
{
